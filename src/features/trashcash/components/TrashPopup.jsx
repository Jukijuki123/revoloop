...
export default function TrashPopup({
    popupOpen,
    setPopupOpen,
    kodeTransaksi,
    detail,
            ...
            >
                    ...
                    <div className="flex justify-center">
                        <div id="qr-canvas" className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm flex flex-col items-center">
                            ...
                            <p className="text-xs text-gray-400 mt-3">
                                Kode: <span className="text-gray-600">{kodeTransaksi}</span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="border border-gray-200 rounded-2xl px-5 py-4 space-y-3 text-sm">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="font-medium text-gray-800">{detail.jenis}</span>
                            </div>

                            <div className="flex justify-between">
                                <span className="text-gray-500">Jumlah</span>
                                <span className="font-medium text-gray-800">{detail.jumlah}</span>
                            </div>

                            <div className="flex justify-between">
                                <span className="text-gray-500">Lokasi</span>
                                <span className="font-medium text-gray-800">{detail.lokasi}</span>
                            </div>

                            <div className="flex justify-between">
                                <span className="text-gray-500">Jadwal</span>
                                <span className="font-medium text-gray-800">{detail.jadwal}</span>
                            </div>
                ...
                <div className="px-4 py-4 bg-white border-t border-gray-100 flex gap-3 rounded-b-2xl">
                    <button
                        ...
                        className="flex-1 bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 rounded-xl transition text-sm cursor-pointer"
                    >
                        Download QR
                    </button>
                    <button
                        type="button"
                        onClick={() => setPopupOpen(false)}
                        className="flex-1 bg-primary-dark hover:bg-green-950 text-white font-semibold py-3 rounded-xl transition text-sm cursor-pointer"
                    >
                        Kembali
                    </button>
                </div>
