        ...
        <section id="komunitas" className="bg-primary-light py-10 px-4 md:px-8 lg:px-10 relative">
            <div className="flex flex-col max-w-6xl md:flex-row items-center justify-beetween px-4 mx-auto mt-6">
                ...
                <div className="md:w-1/2 mt-20">
                    <img src="/images/figureKomunitas.png" alt="Pengrajin Sampah" className="md:w-[60%] mx-auto" />
                </div>
            </div>

            <div className="w-full left-0 bottom-0 absolute h-16 lg:h-24 bg-orange-300 rounded-t-3xl"></div>

            <img src="/images/pucuk.png" alt="" className="absolute w-20 top-[120px] left-[100px] hidden lg:block lg:left-[500px] animate-bounce" />
            <img src="/images/botol.png" alt="" className="absolute w-24 bottom-[15px] right-[200px] md:right-[140px] lg:right-[270px] animate-bounce" />
            <img src="/images/tas.png" alt="" className="absolute w-24 bottom-[15px]  right-[50px] md:right-[250px] lg:right-[430px] animate-bounce" />
