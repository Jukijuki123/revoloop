...
const socialLinks = [
  { icon: Globe, url: "https://revoloop.vercel.app" },
  { icon: Globe2, url: "https://twitter.com/" },
  { icon: Share2, url: "https://facebook.com/" },
];
    ...
    <footer className="bg-linear-to-b from-primary-dark via-primary-dark to-primary text-white py-10 px-6 md:px-12 lg:px-16">
      <div className="max-w-7xl mx-auto space-y-8">
          ...
          >
            ...
            <div>
              ...
              <ul className="space-y-1 text-gray-100">
                ...
                <li><a href="#trashcash" className="hover:underline">Tukar Sampah</a></li>
                <li><a href="#komunitas" className="hover:underline">Komunitas</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1 text-gray-100">
                ...
                <li><a href="https://tiktok.com/" target="_blank" rel="noopener noreferrer" className="hover:underline">TikTok</a></li>
              </ul>
            </div>
          </motion.div>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-3 items-start text-sm md:text-base">
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-3">
              <motion.a whileHover={{ scale: 1.03, y: -1 }} whileTap={{ scale: 0.97 }}
                href="https://www.apple.com/app-store/" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-2 bg-white text-gray-900 rounded-xl px-3 py-2 shadow-sm"
              >
                <Apple className="w-6 h-6" />
                <div className="text-left leading-tight">
                  <p className="text-[10px] uppercase tracking-wide">Download on the</p>
          ...
          <div>
            ...
            <a href="https://maps.app.goo.gl/6ftFYGBV5ijAsXMn6" target="_blank" rel="noopener noreferrer"
        ...
        <p className="text-center text-xs text-gray-300">
          © {new Date().getFullYear()} REVOLOOP. All rights reserved. Made by SMK Negeri 26 Jakarta.
        </p>
      </div>
    </footer>
  );
